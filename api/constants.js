...
✍️ To view the emojis I can use, simply type /reactions. To create your own auto reaction bot, head over to: [Auto-Reaction-Bot on GitHub](https://github.com/USDTQBOT/reaction-auto).
...
<button class="button githubBtn" onclick="window.location='https://github.com/USDTQBOT/reaction-auto'">Open Source 🌱</button>

<div style="margin: 5px;">
  <a class="github-button" href="https://github.com/USDTQBOT/reaction-auto" data-size="large" data-show-count="true">Star</a>
